    ...
    <div class="mx-5 px-3 lg:px-4">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">College</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0" data-modal-target="create-modal" data-modal-toggle="create-modal">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">here</th>
                                <td class="px-4 py-3">here</td>
                                <td>
                                    <div  data-modal-target="preview-modal" data-modal-toggle="preview-modal">
                        ...
                        @include('colleges.crud.read')

                        @include('colleges.crud.update')

                        @include('colleges.crud.delete')
