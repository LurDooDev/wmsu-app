<!-- Main modal -->
<div id="create-localfee-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-8/12 max-w-6xl p-8 max-h-screen flex flex-col">
        ...
        <div class="relative p-5 bg-white rounded-lg shadow dark:bg-gray-800 flex-1">
            ...
            <button type="button"
                ...
                data-modal-toggle="create-localfee-modal">
                    ...
                    <div class="mt-8 basis-1/2 pr-4">
                        ...
                        <div action="#" class="grid gap-6">
                            <div class="mb-2">
                                ...
                                <input type="text" name="name" id="name" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg
                                    ...
                                    placeholder="Ex. CCS fee&ldquo;">
                            </div>
                            <div class="mb-2">
                                <label for="amount"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Amount</label>
                                <input type="number" name="amount" id="amount" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg
                                    focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400
                                    dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="P300">
                            </div>
                        ...
                        <div action="#" class="grid gap-6">
                            <div class="mb-2">
                                <label for="academic-year"
                                    ...
                                    Year</label>
                                <select id="academic-year" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <div class="mb-2">
                                ...
                                <select id="semester" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <div class="mb-2">
                                <label for="start-date"
                                    ...
                                    Date</label>
                                <input type="date" name="start-date" id="start-date" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg
                                    focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400
                                    dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div class="mb-2">
                                <label for="end-date"
                                    ...
                                    Date</label>
                                <input type="date" name="end-date" id="end-date" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg
                                    focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400
                                    dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            ...
            <div class="mt-4 flex items-center justify-end dark:border-gray-600 p-2">
                <button data-modal-toggle="create-localfee-modal"
