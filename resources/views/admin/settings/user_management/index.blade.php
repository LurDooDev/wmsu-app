            ...
            <div class="mx-5 px-3 ">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0" data-modal-target="create-user-modal" data-modal-toggle="create-user-modal">
                    ...
                    @include('admin.settings.user_management.crud.create')
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">Computing Studies</td>
                                    <td class="px-4 py-3">Officer</td>
                                    <td class="px-4 py-3">Vice Mayor</td>
                ...
                <div class="grid gap-4 mb-12 grid-cols-2">
                    ...
                    <div class="col-span-6">
                        ...
                        <input type="name" name="name" id="name"
                         ...
                         focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400
                          dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Angelito Sidestepper" required="" value="">
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"></p>
                    </div>
                    ...
                    <div class="col-span-6">
                        ...
                        <select name="College" id="College"
                            ...
                            <option value="College Of Computing Studies">College Of Criminal Justice</option>
                        </select>
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"></p>
                    </div>
