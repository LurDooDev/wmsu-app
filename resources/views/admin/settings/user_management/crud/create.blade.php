            ...
            <form class="p-7 md:p-5">
                <div class="grid gap-5 mb-12 grid-cols-2">
                    <div class="col-span-6">
                        <label for="snumber" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">First
                            Name</label>
                        <input type="snumber" name="snumber" id="snumber"
                    ...
                    <div class="col-span-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <label for="role-admin"
                                class="text-sm font-medium text-gray-900 dark:text-white">Admin</label>

                            <input type="radio" id="role-officer" name="roles" value="officer"
                                class="text-primary-500 focus:ring-primary-500 dark:focus:ring-primary-500 dark:text-white">
                            <label for="role-officer"
                                class="text-sm font-medium text-gray-900 dark:text-white">Officer</label>

                            <input type="radio" id="role-collector" name="roles" value="collector"
                                class="text-primary-500 focus:ring-primary-500 dark:focus:ring-primary-500 dark:text-white">
                            <label for="role-collector"
                                class="text-sm font-medium text-gray-900 dark:text-white">Collector</label>
                        </div>
                    </div>
                ...
                <div class="mt-auto flex items-center justify-end dark:border-gray-600 p-2">
                    <button data-modal-toggle="create-user-modal"
