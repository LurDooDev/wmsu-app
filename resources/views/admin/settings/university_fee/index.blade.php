                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">University Fee</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">June 30, 2023</td>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">USC Fee</td>
                            <td class="px-4 py-3">2nd Semester</td>
                            <td class="px-4 py-3">250</td>
                            <td class="px-4 py-3">August 1, 2023</td>
                            <td class="px-4 py-3">September 30, 2023</td>
                            <td class="px-4 py-3">2022-2023</td>
            ...
            <div class="mt-8">
                ...
                <form action="#" class="grid gap-6">
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" class="input-field-lg w-full" placeholder="Ex. USC fee&ldquo;">
                    </div>
                    <div class="mb-4">
