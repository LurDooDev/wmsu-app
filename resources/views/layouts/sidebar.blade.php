   ...
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
    ...
    <a href="{{ route('officer.payments') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Route::is(['officer.payments', 'officer.paymentNext*','officer.paymentReceipt*']) ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
        ...
        <span class="ms-3">Payments</span>
         ...
         @elseif (Auth::user()->type == 'admin')
            <li>
               <a href="{{route('admin.payments')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Route::is(['officer.payments', 'officer.paymentNext*','officer.paymentReceipt*']) ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                  <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                     <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 2a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1M2 5h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm8 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"/>
                  </svg>
                  <span class="ms-3">Payments</span>
