    ...
    <ol class="relative border-s border-gray-200 dark:border-gray-700">                  
        <li class="mb-10 ms-7">            
            ...
            <div class="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="text-sm font-normal text-gray-500 dark:text-gray-300">Bonnie paid 200 CSC Fee <a href="#" class="font-semibold text-blue-600 dark:text-blue-500 hover:underline">as an officer</a>
                </div>
            </div>
        </li>
        <li class="mb-10 ms-7">            
